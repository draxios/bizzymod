...
public void OnPluginStart()
{
	...
	g_Cvar_InitialDelay = CreateConVar("sm_rtv_initialdelay", "0.0", "Time (in seconds) before first RTV can be held", 0, true, 0.00);
	g_Cvar_Interval = CreateConVar("sm_rtv_interval", "120.0", "Time (in seconds) after a failed RTV before another can be held", 0, true, 0.00);
